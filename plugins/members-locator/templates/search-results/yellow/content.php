...
<div class="gmw-results-wrapper yellow gmw-fl-yellow-results-wrapper <?php echo esc_attr( $gmw['prefix'] ); ?>" data-id="<?php absint( $gmw['ID'] ); ?>" data-prefix="<?php echo esc_attr( $gmw['prefix'] ); ?>">
		...
		<div class="gmw-results">
		    ...
		    <ul class="members-list-wrapper">
		    	...
		    	<?php while ( bp_members() ) : bp_the_member() ; ?>
		            ...
		            <li class="single-member <?php echo esc_attr( $member->location_class ); ?>">
