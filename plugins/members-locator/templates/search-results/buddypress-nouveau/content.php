...
?>
<!-- Generic element to imitate the "buddypress" class in the body tag in the BuddyPress Directory page -->
<div class="buddypress">

	<!--  Main results wrapper -->
	<div id="buddypress" class="<?php gmw_form_class( 'results_wrapper', $gmw ); ?> <?php bp_nouveau_container_classes(); ?>" data-id="<?php echo absint( $gmw['ID'] ); ?>" data-prefix="<?php echo esc_attr( $gmw['prefix'] ); ?>">
		<?php
