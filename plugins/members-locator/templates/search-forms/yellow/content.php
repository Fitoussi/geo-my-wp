 ...
 * it in the form editor. It will show in the "Search form" dropdown menu as "Custom: yellow".
 *
...
<div class="gmw-form-wrapper yellow gmw-fl-yellow-form-wrapper <?php echo $gmw['ID']; ?> <?php echo $gmw['prefix']; ?>">
