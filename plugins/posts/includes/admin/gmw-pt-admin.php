		...
		<div>
			<div id="taxonomies-wrapper" style=" padding: 8px;">
				...
				foreach ($posts as $post) :
					...
					echo '<div id="' . $post . '_cat' . '" class="taxes-wrapper" '; echo ( isset( $gmw_forms[$formID][$section]['post_types'] ) && (count( $gmw_forms[$formID][$section]['post_types'] ) == 1) && ( in_array( $post, $gmw_forms[$formID][$section]['post_types'] ) ) ) ? 'style="display: block; " ' : 'style="display: none;"'; echo '>';
							...
							//if (is_taxonomy_hierarchical($tax)) :
								...
								echo '<div style="border-bottom:1px solid #eee;padding-bottom: 10px;margin-bottom: 10px;" class="gmw-single-taxonomie">';													
									...
									echo '<span id="gmw-st-wrapper">';
										...
										echo '<input type="radio" class="gmw-st-btns" name="gmw_forms[' .$formID .']['.$section.'][taxonomies]['. $tax .'][style]" value="drop" '; if ( isset( $gmw_forms[$formID][$section]['taxonomies'][$tax]['style'] ) && $gmw_forms[$formID][$section]['taxonomies'][$tax]['style'] == 'drop' ) echo  "checked=checked"; echo  ' style="margin-left: 10px; " />'.__('Dropdown','GMW');
									echo '</span>';
