...
a("._wppl_country").val(g)),void 0!=d[x].long_name&&(g=d[x].long_name,a("._wppl_country_long").val(g)))}}h("good")}else alert("Geocoder failed due to: "+k),n(),h("bad")})}function w(){m();var f=a("#_wppl_street").val(),b=a("#_wppl_apt").val(),c=a("#_wppl_city").val(),e=a("#_wppl_state").val(),t=a("#_wppl_zipcode").val(),k=a("#_wppl_country").val();retAddress=f+" "+c+" "+e+" "+t+" "+k;addressApt=f+" "+b+" "+c+" "+e+" "+t+" "+k;geocoder=new google.maps.Geocoder;geocoder.geocode({address:retAddress},
...
a("#_wppl_long").removeAttr("disabled"),a("#_wppl_address").removeAttr("disabled")):(a("#_wppl_lat").removeAttr("disabled"),a("#_wppl_long").removeAttr("disabled"),a("#_wppl_address").removeAttr("disabled"))});""!=a("#_wppl_lat").val()&&""!=a("#_wppl_long").val()&&""!=a("#_wppl_formatted_address")&&q("good");a("#gmw-admin-locator-btn").click(function(){n();m();navigator.geolocation?navigator.geolocation.getCurrentPosition(u,v):alert("Geolocation is not supported by this browser.")});a("#gmw-admin-delete-btn").click(function(){n();
q("bad")});a("#gmw-admin-getlatlong-btn").click(function(){w()});a("#gmw-admin-getaddress-btn").click(function(){m();var a=document.getElementById("_wppl_lat").value,b=document.getElementById("_wppl_long").value;r(a,b,"yes")});jQuery(".metabox-tabs li a").each(function(a){var b=jQuery(this).parent().attr("class").replace(/active /,"");"active"!=jQuery(this).attr("class")&&jQuery("div."+b).hide();jQuery("div."+b).addClass("tab-content");jQuery(this).click(function(){jQuery(this).parent().parent().parent().children("div").hide();
