...
<div class="gmw-form-wrapper default gmw-pt-default-form-wrapper <?php echo esc_attr( $gmw['prefix'] ); ?>">
	...
	<form class="gmw-form" name="gmw_form" action="<?php gmw_form_results_page( $gmw ); ?>" method="get" data-id="<?php echo esc_attr( $gmw['ID'] ); ?>" data-prefix="<?php echo esc_attr( $gmw['prefix'] ); ?>">
