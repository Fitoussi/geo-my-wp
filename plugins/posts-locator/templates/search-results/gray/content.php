 ...
 */
?>
<div class="gmw-results-wrapper gray gmw-pt-gray-results-wrapper <?php echo esc_attr( $gmw['prefix'] ); ?>" data-id="<?php absint( $gmw['ID'] ); ?>" data-prefix="<?php echo esc_attr( $gmw['prefix'] ); ?>">
        ...
        <div class="gmw-results">
			...
			<ul class="posts-list-wrapper">
				...
				<?php while ( $gmw_query->have_posts() ) : $gmw_query->the_post(); ?>
					...
					<li id="post-<?php the_ID(); ?>" class="<?php echo esc_attr( $post->location_class ); ?>">
