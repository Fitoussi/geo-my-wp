 ...
 * it in the form editor. It will show in the "Search results" dropdown menu as "Custom: gray".
 *
 ...
 */
?>
<div class="gmw-results-wrapper gray gmw-pt-gray-results-wrapper <?php echo $gmw['ID']; ?> <?php echo $gmw['prefix']; ?>">
