...
<div class="gmw-results-wrapper grid-gray gmw-pt-grid-gray-results-wrapper <?php echo $gmw['ID']; ?> <?php echo $gmw['prefix']; ?>">
				   			...
				   			<div class="bottom-wrapper">
					    		...
					    		<?php } else { ?>
			                        ...
			                        <div class="address-wrapper">
								    	<span class="gmw-icon-location address-icon"></span>
