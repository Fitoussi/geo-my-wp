...
if ( ! class_exists( 'GMW_Extensions') ) :
...
class GMW_Extensions {
    ...
    public function __construct() {
    	...
    	if ( empty( $_GET['page'] ) || $_GET['page'] != 'gmw-extensions' ) {
    		return;
        }
    ...
    public static function activate_extension() {
        ...
        if ( empty( $_GET['gmw_action'] ) || $_GET['gmw_action'] != 'activate_extension' ) {
            wp_die();
        }
        ...
        if ( defined( 'DOING_AJAX' ) && DOING_AJAX ) {
            ...
            //reload the page to prevent resubmission
            wp_safe_redirect( admin_url( 'admin.php?page=gmw-extensions&gmw_notice=extension_activated&gmw_notice_status=updated' 
            ) );
        ...
        <div id="gmw-extensions-page" class="wrap gmw-admin-page">
            ...
            <div class="extensions-wrapper">
                ...
                <?php foreach ( $extensions_data as $extension ) : ?>
                    ...
                    $status_class = ( $extension['status'] == 'disabled' ) ? 'inactive disabled' : $extension['status'];
                    ?>
                    <!-- extension wrapper -->
                    <div 
