...
class GMW_Settings {
	...
	protected function init_settings() {
		...
		$this->settings = apply_filters( 'gmw_admin_settings',
			array(
				...
				<?php
					...
					foreach ( $this->settings as $key => $section ) {
						...
						echo '<table class="widefat fixed">
								<thead>
									<tr>
										<th scope="col" id="cb" class="manage-column column-cb check-column" style="width:50px;padding:11px 10px">'.__( 'Feature', 'GMW' ).'</th>
								        <th scope="col" id="cb" class="manage-column column-cb check-column" style="width:50px;padding:11px 10px">'.__( 'Settings', 'GMW' ).'</th>
								        <th scope="col" id="cb" class="manage-column column-cb check-column" style="width:50px;padding:11px 10px">'.__( 'Explanation', 'GMW' ).'</th>
							        </tr>
							    </thead>';
