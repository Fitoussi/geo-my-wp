...
1!=gmwGetCookie("gmw_autolocate")&&(gmwSetCookie("gmw_autolocate",1,1),e=!0,GmwAutoLocator(c,h));a(".gmw-locate-btn").click(function(){g=a(this).closest("form").find(".gmw-form-id").val();locatorButton=a(this);b=a(this).closest("form");b.find(".gmw-lat").val("");b.find(".gmw-lng").val("");a(this).toggleClass("locator-submitted");locatorButton.fadeToggle("fast",function(){a("#gmw-locator-btn-loader-"+g).fadeToggle("fast",function(){a(".gmw-address").attr("disabled","disabled");a(".gmw-submit").attr("disabled",
"disabled");GmwAutoLocator(c,h)})})})});