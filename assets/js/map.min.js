...
jQuery(document).ready(function(a){if("undefined"==typeof gmwMapObjects)return!1;a.each(gmwMapObjects,function(a,b){1==b.triggerMap&&(0!=b.hiddenElement&&jQuery(b.hiddenElement).is(":hidden")?jQuery(b.hiddenElement).slideToggle("fast",function(){gmwMapInit(b)}):gmwMapInit(b))})});